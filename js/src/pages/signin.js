import {PbqSignupPage} from "./signup";
import {PubliqOauth} from "../oauth";
import {MDCLinearProgress} from '@material/linear-progress';

export class PbqSigninPage {
    constructor(wrapper) {
    ...
    load() {
        ...
        var params = [['action', 'pbq_signin_page_content']];
    ...
    init() {
        ...
        this.emailField = this.wrapper.querySelector('.pbq-signin-email-input');
        ...
        this.wrapper.querySelector('.pbq-session-signup-init').addEventListener('click', (e) => {
            e.preventDefault();
            this.formWrapper.classList.add('pbq-session-form-loading');
            this.progressBar.open();
            new PbqSignupPage(this.wrapper);
        });
    }
